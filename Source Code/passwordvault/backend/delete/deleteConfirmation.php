      ...
      <form class="row row-cols-lg-auto g-3 align-items-center" action="" method="POST">        
        <div class="col-12" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="input-group">
            ...
            <input type="password" class="form-control" id="inlineFormInputGroupPassword" name="inlineFormInputPassword" placeholder="Enter the master password for <?php echo $_SESSION["username"]; ?>">
          </div>
        </div>
