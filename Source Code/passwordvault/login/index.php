...
<html lang="en">
  ...
  <div class="container">
    <div class="form-custom" data-aos="fade-up">
      <form class="row row-cols-lg-auto g-3 align-items-center" action="../backend/login/" method="POST">
        ...
        <div class="col-12" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="input-group">
            ...
            <input type="password" class="form-control" id="inlineFormInputGroupPassword" name="inlineFormInputPassword" placeholder="Password" required>
          </div>
        </div>
    ...
    <div class="new-user" data-aos="fade-up" data-aos-delay="400">
      <p class="new-user-text">Are you a new user?<a href="../register/"><button class="btn btn-md register-button">Register Here</button></a></p>
    </div>    
    <div class="new-user" data-aos="fade-up" data-aos-delay="400">
      <p class="new-user-text"><b><i><?php echo $error;?></i></b></p>
    </div>
  </div>
